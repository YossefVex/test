				...
				void 0 ===
					(n =
						...
						typeof (r = function () {
							...
							function i(e, i) {
								[e, i].forEach(n);
								for (var o = t(e), a = t(i), s = 0; s < Math.max(o.length - 1, a.length - 1); s++) {
								...
								if (c && f) {
									...
									for (s = 0; s < Math.max(h.length, d.length); s++) {
										if (void 0 === h[s] || ('string' == typeof d[s] && 'number' == typeof h[s])) return -1;
										if (void 0 === d[s] || ('string' == typeof h[s] && 'number' == typeof d[s])) return 1;
										if (h[s] > d[s]) return 1;
										if (d[s] > h[s]) return -1;
									}
				...
				e: for (; (e[p - 1] != o || 0 == p) && !this._isInvalid; ) {
					...
					switch (v) {
						...
						case 'relative or authority':
							...
							break;
						case 'relative':
							if (((this._isRelative = !0), 'file' != this._scheme && (this._scheme = r._scheme), o == _)) {
								(this._host = r._host),
									(this._port = r._port),
							...
							if ('/' == _ || '\\' == _) '\\' == _ && l('\\ is an invalid code point.'), (v = 'relative slash');
								...
								if ('#' != _) {
									var w = e[p + 1],
										k = e[p + 2];
									('file' != this._scheme || !a.test(_) || (':' != w && '|' != w) || (o != k && '/' != k && '\\' != k && '?' != k && '#' != k)) &&
										((this._host = r._host),
										(this._port = r._port),
										(this._username = r._username),
										(this._password = r._password),
						...
						case 'relative slash':
							if ('/' != _ && '\\' != _) {
								'file' != this._scheme && ((this._host = r._host), (this._port = r._port), (this._username = r._username), (this._password = r._password)),
									(v = 'relative path');
								continue;
							}
						...
						case 'file host':
							if (o == _ || '/' == _ || '\\' == _ || '?' == _ || '#' == _) {
								2 != y.length || !a.test(y[0]) || (':' != y[1] && '|' != y[1])
									? (0 == y.length || ((this._host = f.call(this, y)), (y = '')), (v = 'relative path start'))
									: (v = 'relative path');
								continue;
							}
							...
							o != _ && '/' != _ && '\\' != _ && (t || ('?' != _ && '#' != _))
								...
								: ('\\' == _ && l('\\ not allowed in relative path.'),
								  ...
								  '..' == y
										...
										? this._path.push('')
										: '.' != y &&
										  ('file' == this._scheme && 0 == this._path.length && 2 == y.length && a.test(y[0]) && '|' == y[1] && (y = y[0] + ':'),
										  this._path.push(y)),
								  (y = ''),
				...
				try {
					(Array.isArray(t) || (t && 'object' === n(t))) &&
						Object.entries(t).forEach(function (t) {
							var r = e(t, 2),
								n = r[0];
							i(r[1], u, { _path: s.concat(n) }).forEach(function (e) {
								return l.push(e);
							});
						});
				} catch (e) {
							...
							u(this, 'onWindowMessage', function (e) {
								...
								if ((null == e ? void 0 : e.source) === (null === (t = r.iframe) || void 0 === t ? void 0 : t.contentWindow))
									if ('unlayer:destroy' !== (null == e || null === (n = e.data) || void 0 === n ? void 0 : n.action)) {
										var o,
											a = window.__unlayer_multipleEditors ? (null == e || null === (i = e.data) || void 0 === i ? void 0 : i.frameId) : 1;
										a && (null === (o = f[a]) || void 0 === o || o.receiveMessage(e));
									} else r.destroy();
							}),
										...
										i(e, function (e) {
											...
											try {
												(i = n.reduce(function (e, t) {
													...
													(n.slice(0, -1).reduce(function (e, t) {
														return e[t];
													}, e)[n.slice(-1)[0]] = null);
											} catch (e) {
												console.error(e);
											...
											var o = t.callbackId++,
												a = t.id;
											(t.callbacks[o] = i), (r.__unlayer_functions_map[n.join('.')] = { frameId: a, callbackId: o });
										}),
										r
									);
								}
							...
							},
							{
								...
								value: function (e) {
									var t = e.action,
										...
										i = e.result,
										o = e.resultArgs,
										a = Array.isArray(o) ? o : [i],
										s = null != i ? i : a[0],
										l = this.callbacks[r];
									switch (t) {
										case 'response':
											l && (l(s), delete this.callbacks[r]);
											break;
										case 'callback':
											var u;
											if (
												(null != a &&
													...
													void 0 !== u &&
													u.attachments &&
													(a[0].attachments = a[0].attachments.map(function (e) {
												...
												l.apply(
													null,
													a.concat(function () {
														c.postMessage('done', { doneId: n, resultArgs: Array.from(arguments), result: Array.from(arguments)[0] });
													})
												);
											}
									}
								...
								t && 'object' === v(t)
									? Object.entries(t || {}).reduce(function (e, t) {
											...
											return Object.assign(
												...
												})({}, a, 'function' == typeof s ? ''.concat(null != (r = s) ? r : '') : s)
											);
									  }, {})
									: t)
						}
							...
							(function (e) {
								...
								Object.entries(r).forEach(function (r) {
									var n = g(r, 2),
										i = n[0],
										o = n[1];
									i && 'string' == typeof i && (t.includes(i) || i.startsWith('__') || Object.defineProperty(e, i, Object.assign({}, o, { enumerable: !0 })));
								});
							})(this),
							t && this.init(t);
					}
						...
						(n = [
							...
							},
							{
								...
								value: function (e) {
									...
									var o,
										a = e.version || '1.5.31',
										s = ''.concat(r.p).concat(a, '/editor.html'),
										l = !1 === e.render ? ''.concat(s, '?norender=true') : s;
									((o = a).startsWith('dev') || o.startsWith('qa') ? 1 : r(9051)(o, '1.0.57')) <= 0 && (window.__unlayer_multipleEditors = !1),
										(this.frame = new h(l)),
										null === (n = this.frame) ||
											void 0 === n ||
							...
							},
							{
								...
								value: function (e) {
									var t,
										r = null;
									if ((e.id ? (r = document.getElementById(e.id)) : e.className && (r = document.getElementsByClassName(e.className)[0]), !e.id && !e.className))
							...
							},
							{
								...
								value: function (e) {
									...
									if (
										...
										e.validator && (n.validator = e.validator.toString()),
										e.tools)
									) {
							...
							},
							{
								...
								value: function (e) {
									var t;
									null === (t = this.frame) || void 0 === t || t.postMessage('showPreview', { device: e });
								}
							},
							{
								key: 'hidePreview',
							...
							},
							{
								...
								value: function (e) {
									...
									'function' == typeof e || null === e
										? null === (t = this.frame) || void 0 === t || t.withMessage('setValidator', { validator: null === e ? null : e.toString() })
								...
								value: function (e, t) {
									...
									e && 'string' == typeof e
										? 'function' == typeof t || null === t
											? null === (r = this.frame) ||
											  void 0 === r ||
											  r.withMessage('setToolValidator', { tool: e, validator: null === t ? null : t.toString() })
							...
							},
							{
								...
								value: function () {
									throw new Error(I('registerContainerExporter'));
								}
							},
							{
								key: 'registerItemExporter',
								value: function () {
									throw new Error(I('registerItemExporter'));
								}
							},
							{
								key: 'registerTool',
								value: function () {
									throw new Error(I('registerTool'));
								}
							},
							{
								key: 'registerPropertyEditor',
								value: function () {
									throw new Error(I('registerPropertyEditor'));
								}
							},
							{
								key: 'registerTab',
								value: function () {
									throw new Error(I('registerTab'));
								}
							},
							{
								key: 'createPanel',
								value: function () {
									throw new Error(I('createPanel'));
								}
							},
							{
								key: 'createViewer',
								value: function () {
									throw new Error(I('createViewer'));
								}
							},
							{
								key: 'createWidget',
								value: function () {
									throw new Error(I('createWidget'));
								}
							}
						]),
						n && M(t.prototype, n),
